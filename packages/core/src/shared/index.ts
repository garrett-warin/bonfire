import { RuntimeKitConfig, RuntimeKitFlags, RuntimeKitVersionInfo } from "@/types";
...
export type RuntimeKitInterface = {
...
export type RuntimeKitContext = {
	config: RuntimeKitConfig;
	prefix: URL;
	interface: RuntimeKitInterface;
	cookieJar: CookieJar;
	hooks?: {
		rewriter: {
