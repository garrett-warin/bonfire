...
async function project() {
	...
	program.description(
		"A CLI to easily get started with creating a RuntimeKit or Ultraviolet Proxy"
	);
	program.argument(
		"[dir]",
			...
			type: () =>
				prompt.select({
					...
					options: [
						...
						// 	value: "static",
						// 	label:
						// 		"Static (can be deployed anywhere, but requires an external StreamRelay server)",
						// },
					],
				}),
		},
