...
export default [
	...
	basicTest({
		...
		js: `
			const tt = window.trustedTypes;
			const name = "runtimekit-test-basic-" + Math.random().toString(36).slice(2, 10);
	...
	// this can actually throw if its enabled in the csp, we dont emulate csp in runtimekit
	...
	basicTest({
		...
		js: `
			const tt = window.trustedTypes;
			const name = "runtimekit-test-dup-" + Math.random().toString(36).slice(2, 10);
	...
	*/
	basicTest({
		...
		js: `
			const tt = window.trustedTypes;
			const name = "runtimekit-test-miss-" + Math.random().toString(36).slice(2, 10);
	...
	basicTest({
		...
		js: `
			const tt = window.trustedTypes;
			const name = "runtimekit-test-in-" + Math.random().toString(36).slice(2, 10);
			let captured;
			let capturedExtras;
			const pol = tt.createPolicy(name, {
	...
	basicTest({
		...
		js: `
			const tt = window.trustedTypes;
			const name = "runtimekit-test-coerce-" + Math.random().toString(36).slice(2, 10);
			let captured;
			const pol = tt.createPolicy(name, {
				createHTML: (input) => {
					captured = input;
	...
	basicTest({
		...
		js: `
			const tt = window.trustedTypes;
			const name = "runtimekit-test-is-" + Math.random().toString(36).slice(2, 10);
			const pol = tt.createPolicy(name, {
				createHTML: (s) => s,
				createScript: (s) => s,
				createScriptURL: (s) => s,
	...
	basicTest({
		...
		js: `
			const tt = window.trustedTypes;
			const name = "runtimekit-test-ih-" + Math.random().toString(36).slice(2, 10);
			const pol = tt.createPolicy(name, { createHTML: (s) => s });
	...
	basicTest({
		...
		js: `
			// runtimekit strips CSP so a plain string assignment to innerHTML must
	...
	basicTest({
		...
		js: `
			const tt = window.trustedTypes;
			const name = "runtimekit-test-sru-" + Math.random().toString(36).slice(2, 10);
			const pol = tt.createPolicy(name, {
				createScriptURL: (s) => s,
			});
	...
	basicTest({
		...
		js: `
			const tt = window.trustedTypes;
			const name = "runtimekit-test-st-" + Math.random().toString(36).slice(2, 10);
			const pol = tt.createPolicy(name, { createScript: (s) => s });
			const ts = pol.createScript("var x = 1;");
			const script = document.createElement("script");
			script.text = ts;
			// either the textContent passed through or runtimekit rewrote it; either
	...
	basicTest({
		...
		js: `
			const tt = window.trustedTypes;
			const name = "runtimekit-test-sd-" + Math.random().toString(36).slice(2, 10);
			const pol = tt.createPolicy(name, { createHTML: (s) => s });
	...
	basicTest({
		...
		js: `
			const tt = window.trustedTypes;
			const name = "runtimekit-test-ts-" + Math.random().toString(36).slice(2, 10);
			const pol = tt.createPolicy(name, {
				createHTML: (s) => "[" + s + "]",
			});
	...
	basicTest({
		...
		js: `
			const tt = window.trustedTypes;
			const a = "runtimekit-test-ind-a-" + Math.random().toString(36).slice(2, 10);
			const b = "runtimekit-test-ind-b-" + Math.random().toString(36).slice(2, 10);
