...
/**
 * Worklet-related fetch-metadata tests. RuntimeKit doesn't currently proxy
 ...
 * tests (audio/paint worklet — runtimekit doesn't proxy worklets) are excluded.
 */
...
export const COOKIE_WPT_FILES = [
	...
	// SameSite test pages (all .https.html — run over HTTP since RuntimeKit treats all as HTTPS)
