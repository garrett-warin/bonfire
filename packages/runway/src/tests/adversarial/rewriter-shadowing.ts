...
//   var $runtimekit$temploc = …; $runtimekit$tryset(location,"=",$runtimekit$temploc)
//     || (location = $runtimekit$temploc);
...
export default [
	...
	// ------------------------------------------------------------------
	basicTest({
		// KNOWN FAILURE: the declaration is renamed to $runtimekit$temploc and the
