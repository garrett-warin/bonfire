...
export type TestContext = {
	...
	frame: FrameLocator;
	/** Navigate the iframe to a URL through the runtimekit proxy */
...
export type Test = {
	...
	stop: () => Promise<void>;
	/** If true, only run this test in the runtimekit harness */
	runtimekitOnly?: boolean;
...
export function basicTest(props: {
	...
	const runtimekitOnly =
		props.runtimekitOnly ??
 ...
 * - navigate(url): Navigate the iframe to a URL through runtimekit
 *
 * Example:
 * ```ts
 * playwrightTest({
